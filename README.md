...
<head>
  ...
  <script type="module">
    ...
    // Auth state listener – hide setup screen when signed in
...
<body>
  ...
  <div class="bottom-nav">
    ...
    <button class="nav-item active"><span class="icon">🏠</span><span>Home</span></button>
    <button class="nav-item"><span class="icon">😂</span><span>Jokes</span></button>
    <button class="nav-item"><span class="icon">🎥</span><span>Videos</span></button>
    <button class="nav-item"><span class="icon">📖</span><span>Stories</span></button>
    <button class="nav-item"><span class="icon">🔴</span><span>Live</span></button>
  </div>
